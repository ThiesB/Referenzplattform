...
import com.exxeta.referenzplattform.service.mapper.CustomerReferencesMapper;
...
public class CustomerReferencesResourceIntTest {
    ...
    public void setup() {
        ...
        final CustomerReferencesResource customerReferencesResource = new CustomerReferencesResource(customerReferencesService);
