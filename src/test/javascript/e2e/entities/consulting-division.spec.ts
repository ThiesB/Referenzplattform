...
describe('ConsultingDivision e2e test', () => {
    ...
    it('should load ConsultingDivisions', () => {
        ...
        expect(consultingDivisionComponentsPage.getTitle()).toMatch(/referenzplattformApp.consultingDivision.home.title/);
    ...
    it('should load create ConsultingDivision dialog', () => {
        ...
        expect(consultingDivisionDialogPage.getModalTitle()).toMatch(/referenzplattformApp.consultingDivision.home.createOrEditLabel/);
