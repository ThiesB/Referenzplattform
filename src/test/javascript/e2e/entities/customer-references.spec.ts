...
describe('CustomerReferences e2e test', () => {
    ...
    it('should load CustomerReferences', () => {
        ...
        expect(customerReferencesComponentsPage.getTitle()).toMatch(/referenzplattformApp.customerReferences.home.title/);
    ...
    it('should load create CustomerReferences dialog', () => {
        ...
        expect(customerReferencesDialogPage.getModalTitle()).toMatch(/referenzplattformApp.customerReferences.home.createOrEditLabel/);
