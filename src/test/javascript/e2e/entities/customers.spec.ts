...
describe('Customers e2e test', () => {
    ...
    it('should load Customers', () => {
        ...
        expect(customersComponentsPage.getTitle()).toMatch(/referenzplattformApp.customers.home.title/);
    ...
    it('should load create Customers dialog', () => {
        ...
        expect(customersDialogPage.getModalTitle()).toMatch(/referenzplattformApp.customers.home.createOrEditLabel/);
