...
describe('DocumentTypes e2e test', () => {
    ...
    it('should load DocumentTypes', () => {
        ...
        expect(documentTypesComponentsPage.getTitle()).toMatch(/referenzplattformApp.documentTypes.home.title/);
    ...
    it('should load create DocumentTypes dialog', () => {
        ...
        expect(documentTypesDialogPage.getModalTitle()).toMatch(/referenzplattformApp.documentTypes.home.createOrEditLabel/);
