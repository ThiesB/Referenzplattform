...
describe('Downloads e2e test', () => {
    ...
    it('should load Downloads', () => {
        ...
        expect(downloadsComponentsPage.getTitle()).toMatch(/referenzplattformApp.downloads.home.title/);
    ...
    it('should load create Downloads dialog', () => {
        ...
        expect(downloadsDialogPage.getModalTitle()).toMatch(/referenzplattformApp.downloads.home.createOrEditLabel/);
