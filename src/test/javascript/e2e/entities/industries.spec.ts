...
describe('Industries e2e test', () => {
    ...
    it('should load Industries', () => {
        ...
        expect(industriesComponentsPage.getTitle()).toMatch(/referenzplattformApp.industries.home.title/);
    ...
    it('should load create Industries dialog', () => {
        ...
        expect(industriesDialogPage.getModalTitle()).toMatch(/referenzplattformApp.industries.home.createOrEditLabel/);
