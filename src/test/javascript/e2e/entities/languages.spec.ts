...
describe('Languages e2e test', () => {
    ...
    it('should load Languages', () => {
        ...
        expect(languagesComponentsPage.getTitle()).toMatch(/referenzplattformApp.languages.home.title/);
    ...
    it('should load create Languages dialog', () => {
        ...
        expect(languagesDialogPage.getModalTitle()).toMatch(/referenzplattformApp.languages.home.createOrEditLabel/);
