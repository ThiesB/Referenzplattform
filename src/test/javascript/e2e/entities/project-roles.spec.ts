...
describe('ProjectRoles e2e test', () => {
    ...
    it('should load ProjectRoles', () => {
        ...
        expect(projectRolesComponentsPage.getTitle()).toMatch(/referenzplattformApp.projectRoles.home.title/);
    ...
    it('should load create ProjectRoles dialog', () => {
        ...
        expect(projectRolesDialogPage.getModalTitle()).toMatch(/referenzplattformApp.projectRoles.home.createOrEditLabel/);
