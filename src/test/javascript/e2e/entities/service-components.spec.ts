...
describe('ServiceComponents e2e test', () => {
    ...
    it('should load ServiceComponents', () => {
        ...
        expect(serviceComponentsComponentsPage.getTitle()).toMatch(/referenzplattformApp.serviceComponents.home.title/);
    ...
    it('should load create ServiceComponents dialog', () => {
        ...
        expect(serviceComponentsDialogPage.getModalTitle()).toMatch(/referenzplattformApp.serviceComponents.home.createOrEditLabel/);
